...
## Звонки
- Позвонить самому пользователю → call_user (нужен сохранённый номер).
- Позвонить третьему лицу от имени пользователя → call_third_party(toNumber, targetName, agenda).
