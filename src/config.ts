...
const configSchema = z.object({
  ...
  primaryModelProvider: z.enum(['openrouter', 'deepseek']).default('openrouter'),
  deepseekApiKey: z.string().optional().default(''),
...
const parsed = configSchema.parse({
  ...
  primaryModelProvider: process.env.PRIMARY_MODEL_PROVIDER,
